...
Contributing to <code>angular-iterator</code> is fairly easy. This document shows you how to
get the project, run all provided tests and generate a production ready build.

It also covers provided grunt tasks, that help you developing on <code>angular-iterator</code>.
...
To get the source of <code>angular-iterator</code> clone the git repository via:
...
<code>angular-iterator</code> is now installed and ready to be built.

## Building

<code>angular-iterator</code> comes with a few **grunt tasks** which help you to automate
...
<code>angular-iterator</code>. This task will also **lint**, **test** and **minify** the
source. After running this task, you'll find the following files in a generated
<code>dist</code> folder:

````
dist/angular-iterator-x.x.x.js
dist/angular-iterator-x.x.x.min.js
````
